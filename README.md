...
SahayaAI is an AI-powered web application that helps users understand text in local Indian languages.  
It extracts English text from images (like government forms or official notices), translates it into the user's preferred Indian language, and reads it aloud.
...
```bash
# Clone the repo
git clone https://github.com/lokeshbabugorrepati/SahayaAI.git
